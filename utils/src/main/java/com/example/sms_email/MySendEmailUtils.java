...
public class MySendEmailUtils {
	...
	public static void sendEmail(String strTitle,String strContent) {
		MySendEmailUtils mySendEmailUtils = new MySendEmailUtils();
		// 设置发件人地址、收件人地址、邮件的标题
		mySendEmailUtils.setAddress("18345019902@163.com", "994914624@qq.com",
				strTitle);
		mySendEmailUtils.send(strContent);
	}
